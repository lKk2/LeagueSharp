...
namespace kPoppy
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu.SubMenu("Combo").AddItem(new MenuItem("ComboActive", "ALL IN KEY").SetValue(new KeyBind(32, KeyBindType.Press)));
            ...
            // KS Mode
            Menu.AddSubMenu(new Menu("KSMode", "KS"));
            Menu.SubMenu("KSMode").AddItem(new MenuItem("KSEQ", "Use E+Q TO KS").SetValue(true));
        ...
        static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            var useKs = Menu.Item("KSEQ").GetValue<bool>();
            if (useKs)
            {
                Killsteal();
            }
        ...
        {
            // still under development :S
          var target = SimpleTs.GetTarget(E.Range, SimpleTs.DamageType.Physical);
          if (target == null) return;
            float stunDistance = 300f;
